<div class="container-fluid rounded-top bg-dark text-white text-center h3 mb-3 p-2">Education</div>
    ...
    <table class="table">
      <thead>
        <tr class="bg-dark text-white">
          <th scope="col" class="start text-center">學校</th>
          <th scope="col" class="text-center">求學經歷</th>
      ...
      ?>
        <tr>
          <td class="text-center align-middle">
            <input type="text" name="school[]" value="<?=$value['school'];?>">
          </td>
          <td class="text-center align-middle">
...
<div class="add_about container-fluid mb-3 p-0 table-responsive shadow-sm" style="width: 42%;">
  <h3 class="text-center text-white bg-dark rounded-top mb-0 p-2 border-bottom">新增『EDUCATION』資料</h3>
  <form action="./api/add.php" method="post">
    <table class="table m-0">
      <tr>
        <td class="text-end text-white align-middle border-end bg-dark">學&ensp;&ensp;&ensp;&ensp;校 :</td>
      ...
      <tr>
        <td class="text-end text-white align-middle border-end bg-dark">求學經歷 :</td>
